...
#==========================================================================================
#   構造計算書および構造図面から部材リストを読み込み、比較するツール（ver.2.00）
#       並列処理化による高速バージョン
#
#           一般財団法人日本建築総合試験所
#
#               coded by T.Kanyama  2024/03
#
#==========================================================================================
"""
このプログラムは、構造判定センターに提出される構造計算書（PDF）および構造図の部材リストを精査し、
両者の違い（記載ミス）を検出するプログラムである。
...
def main():
    ...
    if CreateFolfer():
        ...
        Width = 800
        Height = 600
        root.title(u"Member Sheet Check Ver.1")
        root.geometry("800x600")
        root.geometry("{}x{}".format(Width,Height))

        Static1 = tk.Label(text=u'\n構造部材検索プログラム', font=("MSゴシック", "28", "bold"))
        Static1.pack()
